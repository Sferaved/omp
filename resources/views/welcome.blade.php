                                    ...
                                    <li class="col-lg-6 col-sm-12">
                                        <a href="{{route('contact')}}" target="_blank">
                                            ...
                                            <small style="text-align: left">
                                                ...
                                                Ми маємо опит митного оформлення в різних митних режимах різних товарів таких як ігрове, кавове, котельне, деревообробне обладнання, холодильники та пристрої для басейнів. Також займаємося митним оформленням генераторів та компресорів, трансформаторів та електроніки, кондиціонерів, різних запчастин. Невеликі за вагою товари ми також готові оформіти в найкоротший термін: одяг та взуття, парфумерія та косметика, спортивне харчування, будівельні матеріали, побутова хімія, олії.
